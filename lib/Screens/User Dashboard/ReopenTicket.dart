...
class _TicketDetailPageState extends State<Reopenticket> {
  final TextEditingController _remarkController = TextEditingController();
  String _selectedStatus = 'Reopen';
  ...
  void initState() {
    super.initState();
    _selectedStatus = widget.ticketData['status'] ?? 'Reopen';

    if (!_statusOptions.contains(_selectedStatus)) {
      _selectedStatus = 'Reopen';
    }
    _fetchTicketDetails();
  }
  ...
  Future<void> _addRemark() async {
    ...
    try {
      ...
      final statusId = _statusIdMap[_selectedStatus] ?? 1002;
  ...
  void _updateTicket() async {
    ...
    try {
      ...
      final statusId = _statusIdMap[_selectedStatus] ?? 6;
              ...
              ElevatedButton(
                ...
                child: const Row(
                  children: [
                    ...
                    SizedBox(width: 8),
                    Text('Reopen', style: TextStyle(color: Colors.white)),
                  ],
                ),
              ),
            ],
